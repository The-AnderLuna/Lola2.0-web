                                                            ...
                                                            <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-bg-card border border-border-subtle flex items-center justify-center shadow-[0_0_15px_rgba(212,175,55,0.1)] flex-shrink-0 relative overflow-hidden group">
                                                                ...
                                                                <Image 
                                                                    ...
                                                                    className={`w-[70%] h-[70%] object-contain drop-shadow-[0_0_8px_rgba(212,175,55,0.3)] transition-transform duration-300 ${
                                                                        categorias.find(c => c.id === activeCategory)!.nombre.toLowerCase().includes('medicina') ? 'scale-[2.0] md:scale-[2.2] group-hover:scale-[2.3] -translate-x-0.5 translate-y-3' :
                                                                        (categorias.find(c => c.id === activeCategory)!.nombre.toLowerCase().includes('depilaci') || categorias.find(c => c.id === activeCategory)!.nombre.toLowerCase().includes('despigmentaci')) ? 'scale-[1.65] md:scale-[1.75] group-hover:scale-[1.8]' :
